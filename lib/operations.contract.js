...
const PUBLIC_API_OPERATIONS = [
  ...
  { resource: "assessment", operation: "listCases", method: "GET", pathExample: "/assessments/{slug}/cases/" },
  { resource: "assessment", operation: "attachCases", method: "POST", pathExample: "/assessments/{slug}/cases/attach/" },
  { resource: "assessment", operation: "replaceCases", method: "PUT", pathExample: "/assessments/{slug}/cases/replace/" },
  { resource: "assessment", operation: "removeCase", method: "DELETE", pathExample: "/assessments/{slug}/cases/remove/" },

  { resource: "case", operation: "list", method: "GET", pathExample: "/cases/" },
  { resource: "case", operation: "listPlatform", method: "GET", pathExample: "/platform-cases/" },
  { resource: "case", operation: "create", method: "POST", pathExample: "/cases/create/" },
  { resource: "case", operation: "get", method: "GET", pathExample: "/cases/{id}/" },
  { resource: "case", operation: "update", method: "PATCH", pathExample: "/cases/{id}/" },
  { resource: "case", operation: "delete", method: "DELETE", pathExample: "/cases/{id}/" },
  ...
  { resource: "interview", operation: "listOrgCases", method: "GET", pathExample: "/interviews/org-cases/" },
